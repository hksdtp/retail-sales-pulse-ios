...
import { CheckCircle2, AlertCircle, InfoIcon, AlertTriangle } from "lucide-react"
      ...
      {toasts.map(function ({ id, title, description, action, variant, ...props }) {
        return (
          <motion.div
            ...
            className={cn("rounded-2xl overflow-hidden", variant === "success" ? "shadow-emerald-900/5" : 
                                                         variant === "destructive" ? "shadow-red-900/5" : 
                                                         variant === "warning" ? "shadow-amber-900/5" : 
                                                         "shadow-slate-900/5")}
          >
