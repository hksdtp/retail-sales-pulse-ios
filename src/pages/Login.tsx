    ...
    <div className="fixed inset-0 flex items-center justify-center overflow-hidden">
      ...
      {!showLoginForm ? (
        ...
        >
          ...
          <motion.div 
            id="left-section"
            className={`w-full md:w-1/2 h-full flex items-center justify-center p-5 cursor-pointer transition-all duration-300 ${hoveredDepartment === 'project' ? '' : hoveredDepartment === 'retail' ? 'opacity-30 grayscale' : ''}`}
            initial={{ opacity: 0.9 }}
            whileHover={{ 
          ...
          <motion.div 
            id="right-section"
            className={`w-full md:w-1/2 h-full flex items-center justify-center p-5 cursor-pointer transition-all duration-300 ${hoveredDepartment === 'retail' ? '' : hoveredDepartment === 'project' ? 'opacity-30 grayscale' : ''}`}
            initial={{ opacity: 0.9 }}
            whileHover={{ 
              backgroundColor: 'rgba(0,0,0,0.15)',
              transition: { duration: 0.3 }
