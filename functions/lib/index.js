...
app.post('/tasks', async (req, res) => {
  try {
    const taskData = Object.assign(Object.assign({}, req.body), {
  ...
  try {
    ...
    if (role === 'team_leader' && team_id) {
      ...
      if (userDoc.exists) {
        ...
        if (
          (userData === null || userData === void 0 ? void 0 : userData.team_id) !== String(team_id)
        ) {
          logger.warn(
            `Team leader ${user_id} tried to access team ${team_id} but belongs to team ${userData === null || userData === void 0 ? void 0 : userData.team_id}`,
          );
