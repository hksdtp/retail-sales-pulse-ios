  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: 'text-sm md:text-sm font-medium',
        nav: 'space-x-1 flex items-center',
        nav_button: cn(
          buttonVariants({ variant: 'outline' }),
          'h-8 w-8 md:h-7 md:w-7 bg-transparent p-0 opacity-50 hover:opacity-100 mobile-touch-target',
        ),
        ...
        day: cn(
          ...
          'w-full h-10 md:h-9 p-0 font-normal aria-selected:opacity-100 mobile-touch-target flex items-center justify-center',
        ),
