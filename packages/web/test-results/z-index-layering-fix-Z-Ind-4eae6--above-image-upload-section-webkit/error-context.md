...
- Name: Z-Index Layering Fix - TaskFormDialog Dropdowns >> should display MultiUserPicker dropdown above image upload section
- Location: /Users/nih/Bán lẻ/retail-sales-pulse-ios/packages/web/tests/z-index-layering-fix.spec.ts:25:3
...
Call log:
  - navigating to "http://127.0.0.1:8088/", waiting until "load"
    ...
    at /Users/nih/Bán lẻ/retail-sales-pulse-ios/packages/web/tests/z-index-layering-fix.spec.ts:6:16
```
